...
import shader_model_loading from "./shader/model_exploding.ts";
...
export default class Constructor {
  ...
  render = () => {
    ...
    this.ourShader.setFloat("uTime", time);

    // 设置爆炸参数
    this.ourShader.setFloat("uExplosionFactor", this.explosionFactor);
    this.ourShader.setInt("uUseAnimation", this.useAnimation ? 1 : 0);
